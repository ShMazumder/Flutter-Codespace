...
class DailyInviteScreen extends StatefulWidget {
  final TaskService taskService;
  final UserModel user;
  final UserService userService;
  final Future<void> Function() callback;

  const DailyInviteScreen(
      {super.key,
  ...
  @override
  DailyInviteScreenState createState() => DailyInviteScreenState();
}

class DailyInviteScreenState extends State<DailyInviteScreen> {
  @override
  void initState() {
    super.initState();
  }
